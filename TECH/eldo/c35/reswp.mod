...
R1 N1 N2 RDIFFN {6.500e+01*(L-(0))/(W-(-2.500e-07))}
.ENDS RDIFFN
* ----------------------------------------------------------------------
...
+ BETA  ={7.692e-06*(W-(-2.500e-07))/(L-(0))/(1+(1.500e-03)*(TEMPER-2.700e+01))}
+ VTO   ={-1.000e+03+(0.000e+00/(W-(-2.500e-07)))}
+ LAMBDA=0.000e+00 
+ IS    ={2.550e-07*W*L+0.600e-12*(W+L)}    PB   =6.900e-01
+ XTI    =2.026e+00 
+ CGS   ={3.525e-04*W*L+1.875e-10*(W+L)}    RS   =0.000e+00
+ CGD   ={3.525e-04*W*L+1.875e-10*(W+L)}    RD   =0.000e+00
...
R1 N1 N2 RDIFFP {1.150e+02*(L-(0))/(W-(-2.500e-07))}
.ENDS RDIFFP
* ----------------------------------------------------------------------
...
+ BETA  ={4.348e-06*(W-(-2.500e-07))/(L-(0))/(1+(1.500e-03)*(TEMPER-2.700e+01))}
+ VTO   ={-1.000e+03+(0.000e+00/(W-(-2.500e-07)))}
+ LAMBDA=0.000e+00 
+ IS    ={1.400e-07*W*L+1.850e-13*(W+L)}    PB   =1.020e+00
+ XTI    =1.970e+00 
+ CGS   ={5.100e-04*W*L+2.400e-10*(W+L)}    RS   =0.000e+00
+ CGD   ={5.100e-04*W*L+2.400e-10*(W+L)}    RD   =0.000e+00
...
+ BETA  ={8.55e-06*(W-(-2.000e-07))/(L-(0.0000e+00))/(1+(6.2000e-03)*(TEMPER-2.7000e+01))}
+ VTO   ={-6.7638e+01+(9.1799e-05/(W-(-2.000e-07)))}
+ LAMBDA=0.000e+00 
+ IS    ={1.4000e-06*W*L+7.5905e-12*(W+L)}    PB   =5.3000e-01
+ XTI    =1.465e+00 
+ CGS   ={3.0000e-05*W*L+4.0800e-10*(W+L)}    RS   =2.0000e+01
+ CGD   ={3.0000e-05*W*L+4.0800e-10*(W+L)}    RD   =2.0000e+01
...
+CJ     =6.0000e-05 M      =3.9000e-01 VJ     =5.3000e-01 TT     =0.000e+00 
+CJSW   =4.0800e-10 MJSW   =2.7000e-01 FC     =0.500e+00 
...
R1 N1 N2 RPOLY1 {5.0e+00*(L-(0))/(W-(-0.1e-06))}
.ENDS RPOLY1
* ----------------------------------------------------------------------
...
R1 N1 N2 RPOLY2 VALUE={(4.000e+01*(L-(0))/(W-(1.200e-07)))*(1+1.316e-01*(5.85e-04)*(W*1e+6)*V(N1,N2)**2)} 
...
R1 N1 N2 RPOLYH VALUE={(1.000e+03*(L-(0))/(W-(1.558e-07)))*(1+2.019e-03*(-7.468e-04)*(W*1e+6)*V(N1,N2)**2)} 
...
+AP=W*(L+1.300e-06)
+PP=2*(W+L+1.300e-06)
R1 N1 N1L  RPOLY2RFRESMOD VALUE={(4.00e+01*L/(W-1.200e-07))/2*(1+1.316e-01*(5.85e-04)*W*1e+6*V(N1,N2)**2)} 
+TC1={5.85e-04/sqrt(1+1.141e+00/(W*1e+6)**2.00e+00)}
R2 N1L N2  RPOLY2RFRESMOD VALUE={(4.00e+01*L/(W-1.200e-07))/2*(1+1.316e-01*(5.85e-04)*W*1e+6*V(N1,N2)**2)} 
+TC1={5.85e-04/sqrt(1+1.141e+00/(W*1e+6)**2.00e+00)}
CP1 N1 N1L {CP}
CP2 N1L N2 {CP}
CW N1L N3 {AP*9.500e-5+PP*4.900e-11}
.ENDS RPOLY2RF
...
+AP=W*(L+2.500e-06)
+PP=2*(W+L+2.500e-06)
R1 N1 N1L  RPOLYHRFRESMOD VALUE={(1.000e+03*L/(W-1.558e-07))/2*(1+2.019e-03*(-7.468e-04)*W*1e+6*V(N1,N2)**2)} 
+TC1={-7.468e-04/sqrt(1+0.000e+00/(W*1e+6)**0.000e+00)}
R2 N1L N2  RPOLYHRFRESMOD VALUE={(1.000e+03*L/(W-1.558e-07))/2*(1+2.019e-03*(-7.468e-04)*W*1e+6*V(N1,N2)**2)} 
+TC1={-7.468e-04/sqrt(1+0.000e+00/(W*1e+6)**0.000e+00)}
CP1 N1 N1L {CP}
CP2 N1L N2 {CP}
CW N1L N3 {AP*9.500e-5+PP*4.900e-11}
