...
+CEFF={9.028e-04*AREA_CPOLYRF+2.200e-11*PERI_CPOLYRF}
C1 N1 N1L CPOLYRFCAPMOD {9.028e-04*AREA_CPOLYRF+2.200e-11*PERI_CPOLYRF}
RS N1L N2 1.700e+00
CW N2 N2P {(1.181e-04*AP1+1.855e-10*PP1)}
RW N2P N3 3.800e+01
.ENDS CPOLYRF
...
+AREA_CMIMRF=W*L
+PERI_CMIMRF=2*(W+L)
CMIM N1 N12 {(1.376e-03*AREA_CMIMRF+2.340e-10*PERI_CMIMRF)}
RS N12 N2 {(3.000e+00*1.650e-11/AREA_CMIMRF)}
CMW N2 N3 {(1.013e-05*(SQRT(AREA_CMIMRF)+2e-6)**2+8.461e-11*4*(SQRT(AREA_CMIMRF)+2e-6))}
.ENDS CMIMRF
...
* VARIABLES: AREA [m^2], PERI [m].
*
.PARAM CEFF={1.450e-03*AREA+2.340e-10*PERI}
C1 N1 N2 CMIMCAPMOD {1.450e-03*AREA+2.340e-10*PERI} TC1=3.304e-5 
.ENDS CMIM
...
*
*
C1 N1 N2 NGATECAPCAPMOD {5.860e-03*AREA+2.500e-10*PERI}  
.ENDS NGATECAP
...
+K1     =5.8691e-01 
+K2     =-1.127e-01 K3     =0.000e+00 K3B    =0.000e+00 
+NPEAK  =5.659e+16 VTH0=-1.239e+00
...
+TOX    =7.101e-09 NGATE  =0.000e+00 
+NLX    =0.000e+00 
+XL     =5.000e-08 XW     =0.800e-07 
