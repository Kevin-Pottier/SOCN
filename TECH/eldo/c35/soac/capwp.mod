...
+CEFF={7.386e-04*AREA_CPOLYRF+1.800e-11*PERI_CPOLYRF}
C1 N1 N1L CPOLYRFCAPMOD {7.386e-04*AREA_CPOLYRF+1.800e-11*PERI_CPOLYRF}
RS N1L N2 9.000e-01
CW N2 N2P {(9.666e-05*AP1+1.719e-10*PP1)}
RW N2P N3 2.800e+01
.ENDS CPOLYRF
...
+AREA_CMIMRF=W*L
+PERI_CMIMRF=2*(W+L)
CMIM N1 N12 {(1.017e-03*AREA_CMIMRF+1.920e-10*PERI_CMIMRF)}
RS N12 N2 {(1.200e+00*1.650e-11/AREA_CMIMRF)}
CMW N2 N3 {(6.755e-06*(SQRT(AREA_CMIMRF)+2e-6)**2+6.923e-11*4*(SQRT(AREA_CMIMRF)+2e-6))}
.ENDS CMIMRF
...
* VARIABLES: AREA [m^2], PERI [m].
*
.PARAM CEFF={1.050e-03*AREA+1.920e-10*PERI}
C1 N1 N2 CMIMCAPMOD {1.050e-03*AREA+1.920e-10*PERI} TC1=3.304e-5 
* SOAC - CHECKS as defined in "SOAC.M4" (operating conditions)
vn1 n1 n1x 0
vn2 n2 n2x 0
vsub0 PSUB psubx 0 
...
*
*
C1 N1 N2 NGATECAPCAPMOD {4.260e-03*AREA+1.700e-10*PERI}  
* SOAC - CHECKS as defined in "SOAC.M4" (operating conditions)
vn1 n1 n1x 0
vn2 n2 n2x 0
vsub0 PSUB psubx 0 
...
+K1     =3.3814e-01 
+K2     =-6.375e-02 K3     =0.000e+00 K3B    =0.000e+00 
+NPEAK  =3.468e+16 VTH0=-1.039e+00
...
+TOX    =8.072e-09 NGATE  =0.000e+00 
+NLX    =0.000e+00 
+XL     =-5.000e-08 XW     =-0.700e-07 
