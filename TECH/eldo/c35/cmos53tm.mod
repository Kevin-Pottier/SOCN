...
*        *** Threshold voltage related model parameters ***
+K1     =4.1308e-01 
+K2     =4.5125e-02 K3     =1.082e+01 K3B    =3.852e+00 
+NPEAK  =2.187e+17 VTH0=3.911e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.200e-11 CGSO   =1.200e-11 CGBO   =1.100e-10 
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =8.300e-04 CJSW   =2.500e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
...
+CJ     =8.400e-04 M      =3.400e-01 VJ     =6.900e-01 TT     =0.000e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =8.9692e-01 
+K2     =2.5501e-02 K3     =-1.456e+00 K3B    =-2.664e-01 
+NPEAK  =1.446e+17 VTH0=5.794e-01
...
*        *** Threshold voltage related model parameters ***
+K1     =6.6853e-01 
+K2     =4.1219e-03 K3     =6.353e+00 K3B    =-3.586e+00 
+NPEAK  =6.778e+16 VTH0=-6.338e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =6.400e-11 CGSO   =6.400e-11 CGBO   =1.100e-10 
...
*        *** Threshold voltage related model parameters ***
+K1     =6.9963e-01 
+K2     =-7.790e-02 K3     =2.000e+01 K3B    =-1.275e+00 
+NPEAK  =1.083e+17 VTH0=-4.533e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =5.600e-11 CGSO   =5.600e-11 CGBO   =1.100e-10 
...
+CJ     =1.360e-03 M      =5.400e-01 VJ     =1.020e+00 TT     =0.000e+00 
+CJSW   =3.500e-10 MJSW   =4.600e-01 FC     =0.500e+00 
...
+CJ     =8.000e-05 CJSW   =5.100e-10 FC     =0.000e+00 
...
RD D1 D {1.203e+03*4.000e-06/(W+0.000e+00)} TC=6.200e-03  
.ENDS MODNHL
...
*        *** Threshold voltage related model parameters ***
+K1     =5.0855e-01 
+K2     =-0.0000e+00 K3     =0.000e+00 K3B    =0.000e+00 
+NPEAK  =1.588e+17 VTH0=3.656e-01
...
RD D1 D {1.508e+03*4.000e-06/(W+0.000e+00)} TC=6.200e-03  
.ENDS MODNMHL
...
*        *** Threshold voltage related model parameters ***
+K1     =7.5005e-01 
+K2     =5.8718e-02 K3     =0.000e+00 K3B    =0.000e-01 
+NPEAK  =1.440e+17 VTH0=4.950e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.00e-10 CGSO   =1.00e-10 CGBO   =1.100e-10 
+CGDL   =0.000e+00 CGSL   =0.000e+00 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+
