...
+K1     =3.8018e-01 
+K2     =5.0050e-02 K3     =-1.136e+00 K3B    =-4.399e-01 
...
+CGDL   =1.2033e-10 CGSL   =1.2033e-10 CKAPPA =6.000e-01 
...
*        *** Threshold voltage related model parameters ***
+K1     =2.6585e-01 
+K2     =6.2796e-02 K3     =1.082e+01 K3B    =3.852e+00 
+NPEAK  =1.634e+17 VTH0=3.111e-01
...
+CGDL   =3.1667e-10 CGSL   =3.1667e-10 CKAPPA =1.701e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =6.1495e-01 
+K2     =1.2866e-01 K3     =-3.776e+00 K3B    =-7.691e-02 
...
+CGDL   =2.0900e-10 CGSL   =2.0900e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =7.6009e-01 
+K2     =2.6530e-02 K3     =-1.456e+00 K3B    =-2.664e-01 
...
+CGDL   =3.9867e-10 CGSL   =3.9867e-10 CKAPPA =1.904e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =6.3108e-01 
+K2     =3.9998e-02 K3     =8.317e+00 K3B    =-1.479e+00 
...
+CGDL   =6.5333e-11 CGSL   =6.5333e-11 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =6.8411e-01 
+K2     =5.6210e-03 K3     =6.353e+00 K3B    =-3.586e+00 
...
+CGDL   =1.7333e-10 CGSL   =1.7333e-10 CKAPPA =1.437e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =5.9012e-01 
+K2     =-4.433e-02 K3     =1.103e+01 K3B    =-7.580e-01 
...
+CGDL   =1.1667e-10 CGSL   =1.1667e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =7.1157e-01 
+K2     =-6.749e-02 K3     =2.000e+01 K3B    =-1.275e+00 
+NPEAK  =1.309e+17 VTH0=-5.333e-01
...
+CGDL   =2.6000e-10 CGSL   =2.6000e-10 CKAPPA =0.564e-00 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+NOFF   =1.000e+00 VOFFCV =0.000e+00 
*        *** Parasitic resistance and capacitance related model parameters ***
...
+CJ     =1.523e-03 M      =5.400e-01 VJ     =1.020e+00 TT     =0.000e+00 
+CJSW   =3.580e-10 MJSW   =4.600e-01 FC     =0.500e+00 
...
*        *** Threshold voltage related model parameters ***
+K1     =5.6009e-01 
+K2     =-7.327e-03 K3     =-2.240e+00 K3B    =6.954e-01 
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.1000e-10 CGSO   =1.1000e-10 CGBO   =1.1000e-10 
...
*        *** Threshold voltage related model parameters ***
+K1     =7.6812e-01 
+K2     =7.1587e-02 K3     =-2.439e+00 K3B    =4.077e-01 
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =9.9333e-11 CGSO   =9.9333e-11 CGBO   =1.1000e-10 
+CGDL   =0.000e+00 CGSL   =0.000e+00 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+
...
RD D1 D {0.45000e+03*4.000e-06/(W+0.000e+00)} TC=6.200e-03  
.ENDS MODNHL
...
*        *** Threshold voltage related model parameters ***
+K1     =4.4663e-01 
+K2     =-2.880e-03 K3     =0.000e+00 K3B    =0.000e+00 
+NPEAK  =1.186e+17 VTH0=2.656e-01
...
+IS     =0.000e+00 N      =1.000e+00 
+DCAPLEV=2         CBD    =0.000e+00 CBS    =0.000e+00 
+CJ     =6.225e-04 CJSW   =1.875e-10 FC     =0.000e+00 
+MJ     =3.400e-01 MJSW   =2.300e-01 TT     =0.000e+00 
+XTI    =2.030e-00 PB     =6.900e-01 PBSW   =6.900e-01 
* ----------------------------------------------------------------------
...
RD D1 D {1.081e+03*4.000e-06/(W+0.000e+00)} TC=6.200e-03  
.ENDS MODNMHL
...
*        *** Threshold voltage related model parameters ***
+K1     =7.3575e-01 
+K2     =3.8932e-02 K3     =0.000e+00 K3B    =0.000e-01 
+NPEAK  =1.172e+17 VTH0=3.950e-01
...
+PRT    =0.000e+00 
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =8.6667e-11 CGSO   =8.6667e-11 CGBO   =1.1000e-10 
+CGDL   =0.000e+00 CGSL   =0.000e+00 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+
...
*        *** Threshold voltage related model parameters ***
+K1     =4.9952e-01 
+K2     =1.0307e-02 K3     =-1.715e+00 K3B    =6.325e-01 
...
+CGDL   =8.8133e-11 CGSL   =8.8133e-11 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+
*        *** Parasitic resistance and capacitance related model parameters ***
...
*        *** Threshold voltage related model parameters ***
+K1     =-3.223e-01 
+K2     =2.1602e-01 K3     =1.103e+01 K3B    =-7.580e-01 
...
*        *** Overlap capacitance related and dynamic model parameters   ***
+CGDO   =1.000e-12 CGSO   =1.000e-12 CGBO   =1.1000e-10 
+CGDL   =2.7947e-10 CGSL   =2.7947e-10 CKAPPA =6.000e-01 
+CF     =0.000e+00 ELM    =5.000e+00 
+XPART  =1.000e+00 CLC    =1.000e-15 CLE    =6.000e-01 
+
*        *** Parasitic resistance and capacitance related model parameters ***
